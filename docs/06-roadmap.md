...
| W4 retention | active in week 4 post-install | > 20% for a utility |
...
| 7 | Apple review friction (location + notifications rationale) | low | low | Clear permission copy (the designs already model it) |
