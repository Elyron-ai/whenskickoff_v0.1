# WhensKickoff v0.1 — proposition exploration

**Never miss kickoff. Know where to watch.**
...
- **[`docs/`](docs/00-overview.md)** — the proposition pack: options & recommendation, users & market, monetization, data & licensing, platform architecture, roadmap. **Start with [00 · Overview](docs/00-overview.md).**
- **[`prototype/`](prototype/README.md)** — a zero-build clickable prototype of the eight designed app screens. Open [`prototype/index.html`](prototype/index.html) directly in a browser.
